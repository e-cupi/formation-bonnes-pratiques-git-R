...
::: {.incremental}
1. On se place dans la même configuration que dans l'application précédente : un [**mainteneur**]{.blue2} et deux [**développeurs**]{.blue2}
...
5. Utiliser l'interface de `RStudio` ou de `Sublime Merge` pour résoudre le conflit, en choisissant la version du fichier que vous souhaitez conserver, puis `commit`/`push` les modifications
