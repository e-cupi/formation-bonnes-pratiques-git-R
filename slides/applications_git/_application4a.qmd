...
::: {.incremental}
1. Se mettre par [__groupes de 3 personnes__]{.orange}:
    - Une personne aura la responsabilité d’être [**mainteneur**]{.blue2}. Me prévenir pour que je lui donne les droits de maintainer. 
    - Deux personnes seront [**développeurs**]{.blue2}
2. Le mainteneur crée un dépôt sur `Gitlab`. Il/Elle donne des droits au(x) développeur(s) du projet
3. Créer une copie locale (clone) du projet sur son `Z`
