...
:::{.incremental}
- [**https**]{.orange}
  - Sur Gitlab : choix "clone with HTTPS"
  - simple à utiliser
...
- [**ssh**]{.orange}
  - Sur Gitlab : choix "clone with SSH"
  - (plus) complexe à initialiser
  - authentification automatique 
  - seul type d'authentification possible sous AUS
  
Voir les fiches [utilitR](https://www.book.utilitr.org/03_fiches_thematiques/fiche_configurer_git) sur le sujet.
