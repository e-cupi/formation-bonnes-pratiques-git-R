...
![](img/historique_inflation_inter.png){fig-align="center"}
...
- Différentes [__interfaces graphiques__]{.blue2} (`RStudio`, `Sublime Merge`, `VS Code`...)
:::
...
![Source : [itnext.io](https://itnext.io/git-concepts-for-newcomers-part-2-git-repository-working-tree-and-staging-area-a2e720bf3528)](img/completeworkflow_amend.png){height="400" width="500"}

_Commentaires "maison"_

## Commandes essentielles {auto-animate=true}

Quelques exemples _en ligne de commande_
...
Voir le site [documentaire datascience de l'Insee](https://datascience.gitlab-pages.insee.fr/site-documentaire/accueil/) sur le sujet et les fiches [utilitR](https://book.utilitr.org/03_Fiches_thematiques/Fiche_git_utilisation.html).
